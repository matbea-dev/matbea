...
type AlignSelf = "auto" | "normal" | "center" | "start" | "end" | "self-start" | "self-end" | "baseline" | "stretch" | "inherit" | "initial" | "unset";

export const Column: React.FC<ColumnProps> = ({ children, col, alignSelf, order, breakpoints, display }) => {
